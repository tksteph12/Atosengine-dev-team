...
public class Rr implements Serializable {
    ...
    public Rr(Integer idRr, String nomRr, String role, String demandeurRr, String equipeRm, Date dateDebut, Date dateFin, String competenceRr, int gcmRr, String adresse, String ville, int niveauMin, int niveauMax) {
        this.idRr = idRr;
        this.nomRr = nomRr;
        this.role = role;
    ...
    public void setGcmRr(int gcmRr) {
        this.gcmRr = gcmRr;
    }
    ...
    public String toString() {
        return "com.atos.restfull.Rr[ idRr=" + idRr + " ]";
    }
