...
package com.atos.restfull.service;

import com.atos.restfull.Rr;
 ...
 */
@Stateless
@Path("com.atos.restfull.rr")
public class RrFacadeREST extends AbstractFacade<Rr> {
    @PersistenceContext(unitName = "RestWSDBPU")
    ...
    public String sayHello(@QueryParam("name") String name){
        ...
        //return String.valueOf(super.sayHello());
    }
    
    @GET
    @Path("returnRR")
    @Produces({"application/json"})
    public Rr findRR(@QueryParam("id") Integer id) {
        return super.find(id);
    }
