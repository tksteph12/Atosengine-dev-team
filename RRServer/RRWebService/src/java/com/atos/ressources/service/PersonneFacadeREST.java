...
import com.atos.ressources.Personne;
...
public class PersonneFacadeREST extends AbstractFacade<Personne> {
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") String id, Personne entity) {
        super.edit(entity);
    }
    ...
    public Personne find(@PathParam("id") String id) {
